...
{
    // Return nothing if my_array is empty
    if(!isset($my_array))
    {
        return [];
    }
...
if ($input == 1) {
    ...
    $b = array(3244,9467,734,3310,4273,888,3941,4252,473,8198,5483,7359,8137,7939,8740,2573,3534,8321,8480,1669,5230,1456,5957,1844,5322,9773,9063,1280,6980,5948,7500,224,5415,8234,3534,9689,9122,3827,293,5948,8377,5776,9659,2867,67,8399,5440,9953,6721,272);
    echo "Array before sorting:\n";
    print_r($b);
    $bb = quickSort($b);
    echo "Array after sorting:\n";
    ...
    $c = array(8237,6224,5942,8806,9538,6749,8089,2471,5767,2912);
    echo "Array before sorting:\n";
    print_r($c);
    $cc = quickSort($c);
    echo "Array after sorting:\n";
